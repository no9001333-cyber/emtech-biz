...
#  2026-08-25: 철도 두 곳도 이 목록에서 뺐습니다 - 한국철도공사(코레일)는
#  대박낙찰정보와 대조해보니 공고번호가 R26BK... 나라장터 형식과 같아서 이미
#  g2b.py로 자동수집되고 있는 것을 확인했고(예: "경부고속선 광명역 등 14개소
#  구내 광케이블 개량공사"), 국가철도공단은 별도 번호체계(자체 KR전자조달
#  시스템)라 여전히 자동수집은 안 되지만 사용자 요청으로 바로가기 목록에서 제외.)
