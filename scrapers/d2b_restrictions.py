...
주의 (일부러 방어적으로 짬):
  ...
  - 확인에 실패한 공고는 "자동으로 참가가능"이라고 절대 주장하지 않습니다.
    eligible=False로 두고 restrictions에 "자동확인 실패 - 공고문 직접 확인
    필요"라고 명시합니다 (참가 못 하는 공고를 참가가능으로 잘못 보여주는
    것보다, 확인 안 됐다고 솔직히 표시하는 쪽이 훨씬 안전합니다).
